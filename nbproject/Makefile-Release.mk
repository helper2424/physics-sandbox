...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/megaphysics: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/megaphysics ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/BallBody.o: BallBody.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BallBody.o BallBody.cpp
...
${OBJECTDIR}/VoidSerializer.o: VoidSerializer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VoidSerializer.o VoidSerializer.cpp
